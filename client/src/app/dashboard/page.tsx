...
import { CheckCheck, Package, Tag, TrendingDown, TrendingUp } from "lucide-react";
...
const Dashboard = () => {
  return <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 xl:overflow-auto gap-10 pb-4 custom-grid-rows">
   ...
   <StatCard 
    ...
    primaryIcon={<CheckCheck className="text-blue-600 w-6 h-6" />}
    dateRange="22 - 29 October 2023"
    details= {[
      { title: "Dues", amount: "250.00", changePercentage: 131, IconComponent: TrendingUp},
      { title: "Pending Orders", amount: "145", changePercentage: -56, IconComponent: TrendingDown}
    ]}
    />
    <StatCard 
    ...
    dateRange="22 - 29 October 2023"
    details= {[
      { title: "Sales", amount: "1000.00", changePercentage: 131, IconComponent: TrendingUp},
